...
function loader(content, map, meta) {
    ...
    const importItems = result.messages.filter(message = > message.type === 'import' ? message : false
).
    ...
    ;
    const exportItems = result.messages.filter(message = > message.type === 'export' ? message : false
).
    reduce((accumulator, currentValue) = > {
